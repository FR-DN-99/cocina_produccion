...
// Ordenación: añadimos campos calculados para ordenar
...
<template>
    ...
    >
        <div class="bg-bg-panel border-b border-line px-8 py-4">
        ...
        <div class="bg-warn-soft border-b border-[#ebd0a0] px-8 py-2.5 text-xs text-[#8a4708] flex items-center gap-2.5">
            <span class="w-4 h-4 bg-warn text-white rounded-full inline-flex items-center justify-center font-mono text-[11px] font-semibold flex-shrink-0">i</span>
                ...
                <table class="w-full">
                    <thead>
                        <tr class="bg-bg-soft">
                            ...
                            <SortableHeader sort-key="hora_servicio" :current-sort="sortKey" :current-dir="sortDir" @sort="sortBy">Hora servicio</SortableHeader>
